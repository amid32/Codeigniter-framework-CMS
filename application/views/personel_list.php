	...
	<div class="row">
		...
		<br><br>
			<table class="table table-bordered table-hover table-striped">
				...
				<th>Foto</th>
				<th>
					Personel_adi <a href="<?=base_url('personel/order_by/person_name/ASC'); ?>">[a-Z]</a>
				...
				<tbod>
					<?php foreach($list as $row): ?>
						<tr>
							...
							<td>
								<?php if ($row->img_id){?>
								<img style="width: 60px" src="<?=base_url("uploads/$row->img_id");?>" alt="">
								<?php }else { ?>
									<img style="width: 50px" src="<?=base_url("assets/image/default.png");?>" alt="">
								<?php }?>
							</td>
